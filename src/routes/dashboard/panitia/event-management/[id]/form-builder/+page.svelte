		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
			...
			<div class="space-y-3">
				<div class="flex items-center justify-between">
					...
					<button
						onclick={openAddForm}
						class="flex items-center gap-1.5 text-xs font-semibold text-white bg-brand-700 hover:bg-brand-800 px-3 py-1.5 rounded-lg shadow-sm"
					>
					...
					<form onsubmit={handleFormSubmit} class="space-y-4">
						...
						<div class="space-y-1.5">
							...
							<select
								id="q-type"
								bind:value={formType}
								class="w-full text-xs border border-slate-300 rounded-lg px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-brand-600"
							>
								...
								{#each formOptions as _, i}
									<div class="flex items-center gap-2">
										<input
											...
											class="flex-1 text-xs border border-slate-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-brand-600"
										/>
						...
						<div class="flex gap-2 justify-end pt-2 border-t border-slate-100">
							...
							<button
								...
								class="text-xs font-bold text-white bg-brand-700 hover:bg-brand-800 disabled:opacity-60 px-4 py-1.5 rounded-lg"
							>
				...
				{:else}
					<div class="space-y-3">
						<h3 class="text-sm font-bold text-slate-900 flex items-center gap-1.5">
							<Eye class="w-4 h-4 text-brand-700" /> Preview Form Pendaftaran
						</h3>
						{#if questions.length === 0}
